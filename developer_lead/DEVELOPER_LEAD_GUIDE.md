...
Radial has best practices.  Often a client will ask that we perform work in a way that opposes our best practices.  When this occurs, your experience and expertise is valuable.  After thoroughly understanding the client’s preference and their motivation for that preference, you should bring our best practice or your experience to the client.  Often this will lead to a better solution.  Occasionally, you will be able to bring light to aspects of the project that have not been considered, either by you, or by the client.  However, these conversations should always be conducted with humility, and the assurance that meeting a client’s needs is the essential priority.
